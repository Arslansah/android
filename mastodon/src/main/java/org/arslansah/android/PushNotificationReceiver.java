...
import org.arslansah.android.api.requests.notifications.GetNotificationByID;
import org.arslansah.android.api.requests.statuses.CreateStatus;
import org.arslansah.android.api.requests.statuses.SetStatusBookmarked;
import org.arslansah.android.api.requests.statuses.SetStatusFavorited;
import org.arslansah.android.api.requests.statuses.SetStatusReblogged;
...
import org.arslansah.android.model.NotificationAction;
import org.arslansah.android.model.Preferences;
import org.arslansah.android.model.PushNotification;
...
public class PushNotificationReceiver extends BroadcastReceiver{
	...
	public void onReceive(Context context, Intent intent){
					...
					try{
						...
						new GetNotificationByID(pn.notificationId)
								.setCallback(new Callback<>(){
									@Override
									public void onSuccess(org.arslansah.android.model.Notification result){
		...
		if(intent.getBooleanExtra("fromNotificationAction", false)){
			...
			if(intent.hasExtra("notification")){
				org.arslansah.android.model.Notification notification=Parcels.unwrap(intent.getParcelableExtra("notification"));
	...
	public void notifyUnifiedPush(Context context, AccountSession account, org.arslansah.android.model.Notification notification) {
	...
	void notify(Context context, PushNotification pn, String accountID, org.arslansah.android.model.Notification notification){
	...
	private Notification.Action buildNotificationAction(Context context, int notificationId, String accountID, org.arslansah.android.model.Notification notification, String title, NotificationAction action){
	...
	private Notification.Action buildReplyAction(Context context, int notificationId, String accountID, org.arslansah.android.model.Notification notification){
	...
	private void handleReplyAction(Context context, String accountID, Intent intent, org.arslansah.android.model.Notification notification, int notificationId, Preferences preferences) {
